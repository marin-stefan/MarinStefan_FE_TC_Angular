...
import { CardTemplateComponent } from 'src/app/shared/components/card-template/card-template.component';
import { CardModel } from 'src/app/shared/interfaces/card-model';
